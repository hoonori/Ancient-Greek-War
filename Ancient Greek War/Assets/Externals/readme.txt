...
Last Update: v1.3 in January 2018
...
- 13 tile types x 4 variations = 52 tiles total 
...
- includes 34 alpha-background decor objects like trees, rocks, and grass
...
Do note that these tiles don't need any particular version of Unity; this is a tilesheet saved as a png and split and named into sprites. There are also the individual tiles in a separate folder if that's how you roll.
